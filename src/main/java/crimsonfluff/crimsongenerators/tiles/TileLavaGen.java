...
public class TileLavaGen extends TileEntity implements ITickableTileEntity {
    ...
    public TileLavaGen() {
        super(tilesInit.LAVA_GEN_TILE.get());
    }
    ...
    public void tick() {
        ...
        if (ticks == 20) {
            ...
            this.tank.fill(new FluidStack(Fluids.LAVA.getFluid(), 100), IFluidHandler.FluidAction.EXECUTE);
            this.markDirty();
        }
    }
